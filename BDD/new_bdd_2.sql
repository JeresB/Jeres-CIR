...
ALTER TABLE matiere ADD CONSTRAINT FK_matiere_nom_promo FOREIGN KEY (nom_promo) REFERENCES promo(nom_promo);
ALTER TABLE module ADD CONSTRAINT FK_module_nom_promo FOREIGN KEY (nom_promo) REFERENCES promo(nom_promo);
